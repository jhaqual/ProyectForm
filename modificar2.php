...
$modify2="SELECT * FROM mascotas";
$result = mysqli_query($conn, $modify2);
$ver=mysqli_fetch_array($result);
?>

<br><br>
<center><h3>Modificación de datos</h3>
	
<form id="forma1" name="forma1" method="post" action="modificar3.php">
...
<tr>
	...
	<input type="reset" value="Borrar" id="limpiar"/>
	<input type="submit" value="Guardar edición" id="registrar"/></td>
</tr>
